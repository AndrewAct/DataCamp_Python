...
# <script.py> output:
#     The program took 0.237 seconds to complete. The accuracy on the test set is 0.75. The ngram representation had 12347 features.
...
# <script.py> output:
#     The program took 2.682 seconds to complete. The accuracy on the test set is 0.77. The ngram representation had 178240 features.
